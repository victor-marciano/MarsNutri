          ...
          case 8:
            ...
            for (_error in errors) {
              if (errors.hasOwnProperty(_error)) {
                alertify.error(errors[_error][0]);
              }
            }
...
function doCadastro(_x2) {
  return _doCadastro.apply(this, arguments);
}

function _doCadastro() {
  _doCadastro = _asyncToGenerator(
  /*#__PURE__*/
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(data) {
    var response, errors, _error2;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            for (_error2 in errors) {
              if (errors.hasOwnProperty(_error2)) {
                alertify.error(errors[_error2][0]);
              }
            }
...
function cadastro(data) {
  ...
  var axiosCadastro = axios.create();
  var button = "#buttonCadastro"; // interceptor para a requisição

  axiosCadastro.interceptors.request.use(function (config) {
  ...
  axiosCadastro.interceptors.response.use(function (response) {
    disableSpinner(button);
    return response;
  }, function (error) {
    disableSpinner(button);
...
function login(data) {
  ...
  var button = "#buttonLogin"; // interceptor para a requisição
...
function enableSpinner(button) {
  ...
  $(button).html('<div class="spinner-border spinner-border-sm" id="spinnerCadastro" role="status">' + '<span class="sr-only">Processando</span></div>&nbsp;Processando');
...
module.exports = __webpack_require__(/*! C:\Users\Marcika\Desktop\Desenvolvimento\projetos\tcc\resources\js\auth.js */"./resources/js/auth.js");
